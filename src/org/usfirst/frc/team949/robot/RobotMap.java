...
public class RobotMap {
	...
	public final static int leftDriveMotor3 = 5;
	
	public final static int rightDriveMotor1 = 0;
	public final static int rightDriveMotor2 = 1;
	public final static int rightDriveMotor3 = 2;
